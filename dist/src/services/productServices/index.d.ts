...
declare const updateProduct: ({ id, newData }: {
    id: number;
    newData: ProductType;
}) => Promise<void>;
declare const updateUserOrderStatus: (orderNumber: string, status: UserOrderStatus) => Promise<void>;
...
export { createANewProduct, updateUserOrderStatus, updateProduct, getProducts, changeQuantityOfProduct, };
